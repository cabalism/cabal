...
import qualified UnitTests.Distribution.Client.CmdBuildOptions
...
main = do
  ...
  defaultMain $
    testGroup
      ...
      , testGroup
          "UnitTests.Distribution.Client.CmdBuildOptions"
          UnitTests.Distribution.Client.CmdBuildOptions.tests
      , testGroup
