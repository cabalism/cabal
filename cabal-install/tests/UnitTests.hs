...
import qualified UnitTests.Distribution.Client.CmdBuildOptionsCommandUI
...
main = do
  ...
  defaultMain $
    testGroup
      ...
      , testGroup
          "UnitTests.Distribution.Client.CmdBuildOptionsCommandUI"
          UnitTests.Distribution.Client.CmdBuildOptionsCommandUI.tests
      , testGroup
